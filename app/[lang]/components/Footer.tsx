...
import { Box, Flex, Container, SimpleGrid, Stack, Text, HStack, IconButton, useColorModeValue } from '@chakra-ui/react';
    ...
    const footerMenu = [
        {
            ...
            title: 'Информация',
            items: [
                { text: 'Техподдержка (24/7)', url: '#' },
                { text: 'Сообщить о проблеме', url: '#' },
                { text: 'Способы оплаты', url: '#' },
        ...
        },
        {
            ...
            items: [
                { text: 'telegram', url: '#' },
                { text: 'vk', url: '#' },
                { text: 'бот telegram', url: '#' },
            ],
        },
        {
            id: 5,
            title: 'Услуги',
            items: ['Виртуальные Серверы(VPS)', 'Выделенные серверы(DS)', 'Storage', 'VPN'],
        },
        { id: 6, title: 'Аккаунт', items: ['Создать аккаунт'] },
    ];
    return (
        <>
            <div>test</div>
    ...
    const footerMenu = [
        {
            ...
            title: 'Услуги',
            items: [
                { text: 'Виртуальные Серверы(VPS)', url: '#' },
                { text: 'Выделенные серверы(DS)', url: '#' },
                { text: 'Storage', url: '#' },
                { text: 'VPN', url: '#' },
            ],
        },
        ...
        // { id: 6, title: 'Аккаунт', items: [{ text: 'Создать аккаунт', url: '#' }] },
    ];
    return (
            ...
            <Container as={Stack} maxW={'90%'} py={10}>
                <SimpleGrid templateColumns={{ sm: '1fr 1fr', md: '2fr 1fr 1fr 1fr 1fr ' }} spacing={8}>
                    <Stack spacing={6}>
                        ...
                        <Text fontSize={'sm'}>© 2023 ChainOps hosting. All rights reserved</Text>
                        <HStack>
                            <IconButton aria-label="Call Segun" size="md" fontSize="22px" icon={<SiTelegram />} />
                            <IconButton aria-label="Call Segun" size="md" fontSize="22px" icon={<SiVk />} />
                            <IconButton aria-label="Call Segun" size="md" fontSize="22px" icon={<SiYoutube />} />
                        </HStack>
                    </Stack>
                    {footerMenu.map((menuItem) => (
                        <Stack align={'flex-start'}>
                            <ListHeader>{menuItem.title}</ListHeader>
